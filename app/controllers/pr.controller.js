...
exports.create = (req, res) => {
  ...
  if (!req.body.exercise) {
    ...
    res.status(400).send({ message: "Exercise name is not valid." });
    return;
  }
  // Create a Exercise
...
exports.findAll = (req, res) => {
  ...
  Exercise.find({ uid: req.authId }, {__v:0, uid:0}).populate("results", "-__v")
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
// Delete a Result by the id in a specific Exercise
